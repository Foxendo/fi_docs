...
Сразу уточню - Фи работает как на сервере, так и в личке. В личке не будет [кастомной аватарки и имени](#кастомизация). 

По умолчанию, Фи полностью на английском. Это можно поменять введя `fi language ru`. (Перевел я не до конца, делаю это постепенно.)
